            ...
            item {
                LaunchedEffect(Unit) {
                    viewModel.getAllUserEmails(channelID){
                        println("users xxxxxxxxxxxxxxxxxxxxxxxx $it")
                        users.value = it
                        println("users0 xxxxxxxxxxxxxxxxxxxxxxxx ${users.value}")

                    }
                }
                ChannelItem(channelName = channelName, Modifier, true, onClick = {},
//                    onCall = { callButton->
//                    viewModel.getAllUserEmails(channelID) {it->
...
//                            }
//                        }
//                        println("users xxxxxxxxxxxxxxxxxxxxxxxx ${list}")
