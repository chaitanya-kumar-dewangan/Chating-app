package com.example.jatayu.feature.chat
...
import com.example.jatayu.R
import com.example.jatayu.model.Message
            ...
            .addValueEventListener(object : ValueEventListener {
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    snapshot.children.forEach { data ->
                        println("response :${data.value} xxxxxxxxxxxxxxxxxxxxxxx")
                        println("response :${data} xxxxxxxxxxxxxxxxxxxxxxx")
                        println("response000 :${data.getValue()} xxxxxxxxxxxxxxxxxxxxxxx")
    ...
    fun getAllUserEmails(channelID: String, callback: (List<String>) -> Unit) {
        ...
        ref.addListenerForSingleValueEvent(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                println("zzzzzzzzzzzzzzzzzzzzzzzz $userIds")
...
//        registerUserIdtoChannel(channelID)
    ...
    private fun postNotificationToUsers(
        ...
        val fcmUrl = "https://fcm.googleapis.com/v1/projects/chitthi-cf90f/messages:send"
    ...
    private fun getAccessToken(): String {
        val inputStream = context.resources.openRawResource(R.raw.chitthi_jatayu_key)
